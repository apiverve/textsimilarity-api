...
namespace APIVerve.API.TextSimilarity
{
    ...
    /// <summary>
    /// Client for the TextSimilarity API
    /// </summary>
    public class TextSimilarityAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/textsimilarity";
        ...
        {
            { "text1", new ValidationRule { Type = "string", Required = true } },
            { "text2", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public TextSimilarityAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextSimilarityAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextSimilarityAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TextSimilarityQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TextSimilarityQueryOptions options)
        {
        ...
        public ResponseObj Execute(TextSimilarityQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TextSimilarityQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TextSimilarityQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TextSimilarityQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TextSimilarityQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TextSimilarityQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TextSimilarityQueryOptions options)
        {
