// Package textsimilarity provides a Go client for the Text Similarity API.
//
// For more information, visit: https://apiverve.com/marketplace/textsimilarity?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Text Similarity API.
//
// Parameters:
//   - text1 (required): string - The first text to compare. Must be less than 1000 characters
//   - text2 (required): string - The second text to compare. Must be less than 1000 characters
type Request struct {
...
// ResponseData contains the data returned by the Text Similarity API.
type ResponseData struct {
	Simiarity float64 `json:"simiarity"`
	SimilarityCaseSensitive float64 `json:"similarityCaseSensitive"`
	Difference DifferenceData `json:"difference"`
}

// DifferenceData represents the difference object.
